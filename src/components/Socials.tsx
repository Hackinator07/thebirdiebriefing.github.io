...
const SOCIALS = [
	{ href: 'https://www.instagram.com/birdiebriefing/', label: 'Instagram', icon: InstagramIcon },
	{ href: 'https://bsky.app/profile/birdiebriefing.bsky.social', label: 'Bluesky', icon: BlueskyIcon },
	{ href: 'https://www.youtube.com/channel/UCW2vyHWE3bMfum9FPq-8xGw', label: 'YouTube', icon: YouTubeIcon },
];
