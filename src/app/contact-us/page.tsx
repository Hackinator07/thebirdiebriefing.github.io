...
export default function ContactUsPage() {
  ...
  const inquiryTypes = [
    ...
    { value: 'general', label: 'General Inquiries', email: 'hello@birdiebriefing.com' },
    { value: 'advertising', label: 'Advertising', email: 'marketing@birdiebriefing.com' },
    { value: 'press', label: 'Press', email: 'press@birdiebriefing.com' },
    { value: 'event-coverage', label: 'Event Coverage', email: 'coverage@birdiebriefing.com' },
    { value: 'partnerships', label: 'Partnerships', email: 'partners@birdiebriefing.com' },
    { value: 'equipment', label: 'Equipment', email: 'equipment@birdiebriefing.com' },
    { value: 'complaints', label: 'Complaints', email: 'care@birdiebriefing.com' }
  ];
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const subject = selectedInquiry?.label ? `${selectedInquiry.label} - Contact Form Submission` : 'Contact Form Submission';
            ...
            <div className="bg-white rounded-lg p-6 lg:p-8">
              ...
              <div className="max-w-3xl mx-auto text-center mb-8">
                <p className="text-base lg:text-lg text-gray-700 leading-relaxed">
                  Get in touch with The Birdie Briefing team. We'd love to hear from you and will get back to you as soon as possible.
                </p>
              </div>
                  ...
                  {submitStatus === 'success' && (
                    <div className="bg-green-50 border border-green-200 rounded-lg p-3">
                      <div className="flex items-center">
                        ...
                        <p className="text-green-800 font-medium text-sm">Message sent successfully! We'll get back to you soon.</p>
                      </div>
                    </div>
                  )}
                  ...
                  {submitStatus === 'error' && (
                    <div className="bg-red-50 border border-red-200 rounded-lg p-3">
                      <div className="flex items-center">
                        ...
                        <p className="text-red-800 font-medium text-sm">There was an error sending your message. Please try again.</p>
                      </div>
                    </div>
                  )}
                </form>
