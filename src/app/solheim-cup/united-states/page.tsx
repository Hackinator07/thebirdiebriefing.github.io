...
import { getUsSolheimCupRankings, SolheimCupPlayer } from '@/lib/rankings';
...
export default function UnitedStatesSolheimCupPage() {
  const { t } = useTranslation();
  const rankings = getUsSolheimCupRankings();
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <div className="mt-8 grid grid-cols-2 sm:grid-cols-4 gap-4 max-w-4xl mx-auto">
            <div className="bg-green-50 rounded-lg p-4 text-center">
              <div className="text-2xl font-bold text-green-600">{rankings.qualificationInfo.automaticQualification}</div>
              <div className="text-sm text-green-700">Auto Qualify</div>
            </div>
          ...
          <div className="mt-8 max-w-4xl mx-auto">
            <div className="bg-blue-50 rounded-lg p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-blue-800">
                <div>
                  <strong>Automatic Qualification:</strong> Top 7 players on the U.S. Solheim Cup points list at the end of the qualifying period.
                </div>
                <div>
                  <strong>Rolex Rankings:</strong> Top 2 players on the Rolex Women's World Golf Rankings not already qualified.
                </div>
                <div>
                  <strong>Captain's Picks:</strong> 3 players selected by the U.S. Solheim Cup Team Captain.
                </div>
              </div>
            </div>
          </div>
              ...
              <div key={player.id} className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    ...
                    <div className="font-medium text-gray-900">{player.points.toLocaleString()}</div>
                  </div>
                  <div>
