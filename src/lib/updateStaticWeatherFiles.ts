 ...
 */
export async function updateStaticWeatherFiles(eventId: string = '401745905'): Promise<void> {
 ...
 */
export function startWeatherFileAutoUpdate(eventId: string = '401745905'): void {
