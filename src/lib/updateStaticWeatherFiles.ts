 ...
 */
export async function updateStaticWeatherFiles(eventId: string = '401734781'): Promise<void> {
 ...
 */
export function startWeatherFileAutoUpdate(eventId: string = '401734781'): void {
