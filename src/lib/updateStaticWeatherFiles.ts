 ...
 */
export async function updateStaticWeatherFiles(eventId: string = '401734780'): Promise<void> {
 ...
 */
export function startWeatherFileAutoUpdate(eventId: string = '401734780'): void {
