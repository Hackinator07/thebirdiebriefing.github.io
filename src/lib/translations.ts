...
export const translations: Record<string, TranslationKeys> = {
  en: {
    ...
    searchPlaceholder: 'Search players in contention',
  ...
  ja: {
    ...
    searchPlaceholder: '優勝争いのプレイヤーを検索',
  ...
  th: {
    ...
    searchPlaceholder: 'ค้นหาผู้เล่นที่แข่งขัน',
  ...
  vi: {
    ...
    searchPlaceholder: 'Tìm kiếm người chơi cạnh tranh',
  ...
  tl: {
    ...
    searchPlaceholder: 'Maghanap ng mga nakikipagkumpitensyang manlalaro',
  ...
  sv: {
    ...
    searchPlaceholder: 'Sök tävlande spelare',
  ...
  no: {
    ...
    noTournamentData: 'Ingen turneringsdata',
    searchPlaceholder: 'Søk konkurrerende spillere',
  ...
  fr: {
    ...
    searchPlaceholder: 'Rechercher les joueurs en lice',
  ...
  es: {
    ...
    searchPlaceholder: 'Buscar jugadores en competencia',
  ...
  de: {
    ...
    searchPlaceholder: 'Konkurrierende Spieler suchen',
