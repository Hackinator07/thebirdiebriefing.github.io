...
export const translations: Record<string, TranslationKeys> = {
  ...
  th: {
    ...
    solheimCup: 'โซลไฮม์คัพ',
    solheimAbout: 'เกี่ยวกับ',
    theCourse: 'คอร์ส',
    europe: 'ยุโรป',
  ...
  fr: {
    ...
    solheimCup: 'Solheim Cup',
    solheimAbout: 'À propos',
    theCourse: 'Le parcours',
    europe: 'Europe',
