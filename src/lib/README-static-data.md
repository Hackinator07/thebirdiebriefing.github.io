...
staticDataUtils.captureAndPreview("401734779");  // Capture fresh data
staticDataUtils.compare("401734779");            // Compare static vs live
...
staticDataService.updateConfig({
  ...
  enabled: true,
  eventIds: ['401734779', 'other-event-id']
});
```
...
### Compare Data
```javascript
staticDataUtils.compare("401734779");
```
...
```typescript
staticDataService.updateConfig({
  eventIds: ['401734779', '401734780', '401734781']
});
```
