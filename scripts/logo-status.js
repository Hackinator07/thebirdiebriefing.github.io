...
const tournaments = [
  ...
  { name: 'Black Desert Championship', filename: 'black-desert.png' },
  ...
  { name: 'Meijer LPGA Classic for Simply Give', filename: 'meijer-lpga.png' },
  ...
  { name: 'Walmart NW Arkansas Championship presented by P&G', filename: 'walmart-nw-arkansas.png' },
  ...
  { name: 'BMW Ladies Championship', filename: 'bmw-ladies.png' },
  { name: 'Hanwha LIFEPLUS International Crown', filename: 'hanwha-crown.png' },
  { name: 'Maybank Championship', filename: 'maybank-championship.jpg' },
  { name: 'TOTO Japan Classic', filename: 'toto-japan.png' },
